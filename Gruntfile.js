module.exports = function (grunt) {
  grunt.initConfig({
    exec: {
      bandit: "bandit --ini .bandit -r simple_pipes",
      black: "black simple_pipes",
      cspell: "npx cspell -c .cspell.json {*,.*,**/*}",
      isort: "isort simple_pipes",
      mypy: "mypy simple_pipes",
      prettier: "prettier . --write",
      pylint: "pylint --rcfile .pylintrc  --fail-under=8 simple_pipes",
